...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('core_imagetype', 'code',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=4, default='fl'),
                      keep_default=False)

        db.add_column('core_copyrightholder', 'contact_info',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=300, default=u''),
                      keep_default=False)
        db.add_column('core_copyrightholder', 'primary_bds',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=300, default=u''),
                      keep_default=False)
        db.add_column('core_copyrightholder', 'date_record',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=300, default=u''),
                      keep_default=False)
        db.add_column('core_copyrightholder', 'last_name',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=300, default=u''),
                      keep_default=False)
        db.add_column('core_copyrightholder', 'permission_source',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=300, default=u''),
                      keep_default=False)
        db.add_column('core_copyrightholder', 'permission_level',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=300, default=u''),
                      keep_default=False)
        db.add_column('core_copyrightholder', 'permission_location',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=300, default=u''),
                      keep_default=False)
        db.add_column('core_copyrightholder', 'notes',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=1000, default=u''),
                      keep_default=False)

        db.add_column('core_homepageimage', 'partner_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(
                          related_name='home_page_images',
                          to=orm['core.PartnerSite'], default=2),
                      keep_default=False)

        db.add_column('core_conservationstatus', 'variety_subspecies_hybrid',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=80, default=u''),
                      keep_default=False)
        db.add_column('core_conservationstatus', 's_rank',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=10, default=u''),
                      keep_default=False)
        db.add_column('core_conservationstatus', 'endangerment_code',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=10, default=u''),
                      keep_default=False)
        db.add_column('core_conservationstatus', 'allow_public_posting',
                      self.gf('django.db.models.fields.BooleanField')(
                          default=True))
        # db.delete_column('core_conservationstatus', 'label')

        db.add_column('core_distribution', 'present',
                      self.gf('django.db.models.fields.BooleanField')(
                          default=False)),
        db.add_column('core_distribution', 'native',
                      self.gf('django.db.models.fields.BooleanField')(
                          default=False)),
        # db.delete_column('core_distribution', 'status')

    def backwards(self, orm):
        db.delete_column(u'core_imagetype', 'code')

        db.delete_column('core_copyrightholder', 'contact_info')
        db.delete_column('core_copyrightholder', 'primary_bds')
        db.delete_column('core_copyrightholder', 'date_record')
        db.delete_column('core_copyrightholder', 'last_name')
        db.delete_column('core_copyrightholder', 'permission_source')
        db.delete_column('core_copyrightholder', 'permission_level')
        db.delete_column('core_copyrightholder', 'permission_location')
        db.delete_column('core_copyrightholder', 'notes')

        db.delete_column('core_homepageimage', 'partner_site_id')

        db.delete_column('core_conservationstatus',
                         'variety_subspecies_hybrid')
        db.delete_column('core_conservationstatus', 's_rank')
        db.delete_column('core_conservationstatus', 'endangerment_code')
        db.delete_column('core_conservationstatus', 'allow_public_posting')

        db.delete_column('core_distribution', 'present')
        db.delete_column('core_distribution', 'native')

        # db.add_column('core_distribution', 'status',
        #               self.gf('django.db.models.fields.CharField')(
        #                   max_length=100, default='absent'),
        #               keep_default=False)
