...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegionalConservationStatus.rank'
        db.alter_column(u'core_regionalconservationstatus', 'rank', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RegionalConservationStatus.rank'
        raise RuntimeError("Cannot reverse this migration. 'RegionalConservationStatus.rank' and its values cannot be restored.")
