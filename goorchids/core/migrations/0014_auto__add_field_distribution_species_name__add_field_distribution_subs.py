...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Distribution.species_name'
        db.add_column(u'core_distribution', 'species_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, db_index=True),
                      keep_default=False)

        # Adding field 'Distribution.subspecific_epithet'
        db.add_column(u'core_distribution', 'subspecific_epithet',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Distribution.species_name'
        db.delete_column(u'core_distribution', 'species_name')

        # Deleting field 'Distribution.subspecific_epithet'
        db.delete_column(u'core_distribution', 'subspecific_epithet')
