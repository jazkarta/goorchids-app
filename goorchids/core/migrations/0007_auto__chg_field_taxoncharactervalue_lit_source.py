...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaxonCharacterValue.lit_source'
        db.alter_column(u'core_taxoncharactervalue', 'lit_source', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'TaxonCharacterValue.lit_source'
        db.alter_column(u'core_taxoncharactervalue', 'lit_source', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
