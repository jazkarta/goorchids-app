...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lookalike.lookalike_characteristic'
        db.alter_column(u'core_lookalike', 'lookalike_characteristic', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Lookalike.lookalike_characteristic'
        db.alter_column(u'core_lookalike', 'lookalike_characteristic', self.gf('django.db.models.fields.CharField')(max_length=900))
