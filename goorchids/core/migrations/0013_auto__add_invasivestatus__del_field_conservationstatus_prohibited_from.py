...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InvasiveStatus'
        db.create_table(u'core_invasivestatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('taxon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invasive_statuses', to=orm['core.Taxon'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('invasive_in_region', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('prohibited_from_sale', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['InvasiveStatus'])

        # Deleting field 'ConservationStatus.prohibited_from_sale'
        db.delete_column(u'core_conservationstatus', 'prohibited_from_sale')

        # Deleting field 'ConservationStatus.invasive_in_region'
        db.delete_column(u'core_conservationstatus', 'invasive_in_region')


    def backwards(self, orm):
        # Deleting model 'InvasiveStatus'
        db.delete_table(u'core_invasivestatus')

        # Adding field 'ConservationStatus.prohibited_from_sale'
        db.add_column(u'core_conservationstatus', 'prohibited_from_sale',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConservationStatus.invasive_in_region'
        db.add_column(u'core_conservationstatus', 'invasive_in_region',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.taxoncharactervalue': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lit_source': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
