...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegionalConservationStatus.wetland_status'
        db.add_column(u'core_regionalconservationstatus', 'wetland_status',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegionalConservationStatus.wetland_status'
        db.delete_column(u'core_regionalconservationstatus', 'wetland_status')
