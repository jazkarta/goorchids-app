...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegionalConservationStatus.status'
        db.alter_column(u'core_regionalconservationstatus', 'status', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RegionalConservationStatus.status'
        raise RuntimeError("Cannot reverse this migration. 'RegionalConservationStatus.status' and its values cannot be restored.")
    ...
    models = {
        ...
        u'core.character': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'pile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'characters'", 'null': 'True', 'to': u"orm['core.Pile']"}),
