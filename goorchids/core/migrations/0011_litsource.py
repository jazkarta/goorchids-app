...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Add 'literary_source' relation column
        db.add_column(u'core_taxoncharactervalue', 'literary_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(
                          related_name='taxon_character_values', null=True,
                          to=orm['core.SourceCitation']),
                      keep_default=False)

    def backwards(self, orm):
        # Remove column 'literary_source'
        db.delete_column(u'core_taxoncharactervalue', 'literary_source_id')
        # Deleting model 'SourceCitation'
        db.delete_table('core_sourcecitation')
